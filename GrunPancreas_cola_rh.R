setwd("/omics/groups/OE0246/internal/guz/cola_hc/examples/GrunPancreas")
library(cola)
...
library(scRNAseq)
data = readRDS('/omics/groups/OE0246/internal/guz/cola_hc/examples/GrunPancreas/GrunPancreas_data.rds')
